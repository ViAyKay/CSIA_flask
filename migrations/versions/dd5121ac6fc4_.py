...
Revision ID: dd5121ac6fc4
Revises: 4fb87221e5ab
Create Date: 2022-12-26 21:28:28.121232
...
revision = 'dd5121ac6fc4'
down_revision = '4fb87221e5ab'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('apartment_number', sa.String(length=255), nullable=False),
